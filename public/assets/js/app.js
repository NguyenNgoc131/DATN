...
// Hàm để cập nhật ngày và giờ theo múi giờ của TP Hồ Chí Minh
function updateDateTime() {
    var currentDate = new Date();
    
    // Thiết lập múi giờ cho TP Hồ Chí Minh (GMT+7)
    var timeZone = 'Asia/Ho_Chi_Minh';
    
    // Tùy chọn cho ngày
    var dateOptions = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', timeZone: timeZone };

    // Tùy chọn cho giờ
    var timeOptions = { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false, timeZone: timeZone };
    ...
    if (currentDateElement && currentTimeElement) {
        // Hiển thị ngày và giờ nếu các phần tử tồn tại
        currentDateElement.textContent = currentDate.toLocaleDateString('vi-VN', dateOptions);
        currentTimeElement.textContent = currentDate.toLocaleTimeString('vi-VN', timeOptions);
    }
}
...
// Gọi hàm cập nhật ngày và giờ ngay lập tức
updateDateTime();
