...
<head>
    ...
    <title>Tỉnh thành | VietBidding</title>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <header class="widget-header">
                                <h4 class="widget-title">Danh sách tỉnh thành</h4>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center">Số TBMT mới trong tháng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($linhVucTotals as $provinceName => $provinceData)
                                        <tr>
                                            <td>{{ $provinceName }}</td>
                                            <td style="text-align: center">{{ $provinceData['totalCount'] }}</td>
                                            <td>
                                                <!-- Hiển thị cột Lĩnh vực với các cột nhỏ là tên các loại lĩnh vực -->
                                                @foreach ($allCategories as $category)
                                                    <span>{{ $category }}: {{ $provinceData['categories'][$category] ?? 0 }}<br> </span>
                                                @endforeach
                                            </td>
                                            <td>{{ number_format($provinceData['totalValue']) }}</td>
                                            <td style="text-align: center">{{ $provinceData['newCount'] }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
