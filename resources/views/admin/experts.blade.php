...
<head>
    ...
    <title>Thông tin chuyên gia | VietBidding</title>
...
<body class="menubar-left menubar-unfold menubar-light theme-primary">
        ...
        <div class="navbar-container container-fluid">
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
                    ...
                    <li>
                        <h5 class="page-title hidden-menubar-top hidden-float">Thông tin chuyên gia</h5>
                    </li>
                </ul>
            ...
            <div class="menubar-scroll-inner">
                <ul class="app-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href="{{ route('admin.getLinhVuc') }}"><span class="menu-text">Lĩnh vực</span></a></li>
                            <li><a href="{{ route('admin.getCity') }}"><span class="menu-text">Tỉnh thành</span></a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Bằng cấp</th>
                                            <th>Kinh nghiệm tư vấn</th>
                                            <th>Email</th>
                                            <th>Gói thầu đang tư vấn</th>
                                            <th>Gói thầu tư vấn thành công</th>
                                    ...
                                    <tbody>
                                        @foreach ($datas as $item)
                                            <tr>
                                                ...
                                                <td>{{ substr($item['email'], 0, 5) . str_repeat('*', strlen($item['email']) - 15) . substr($item['email'], -10) }}
                                                </td>
                                                <td style="text-align: center">{{ $item['appointment_bids'] }}</td>
                                                <td style="text-align: center">{{ $item['successful_bids'] }}</td>
                                                <td style="text-align: center">{{ $item['success_rate'] }}%</td>
                                                <td>

                                                    <form
                                                        action="{{ route('admin.deleteExpert', ['id' => $item['id']]) }}"
                                                        method="post">
                                                        @csrf
                                ...
                                <button id="addExpertBtn" class="btn btn-primary mb-3" style="margin-right: 5%">Thêm chuyên gia</button>

                                <form action="{{ route('admin.addExpert') }}" method="post" id="addExpertForm"
                                    style="display: none;">
                                    @csrf
                                    <tr>
                                        <td><input type="text" name="name" placeholder="Tên chuyên gia"
                                                required></td>
                                        <td><input type="text" name="degree" placeholder="Bằng cấp" required>
                                        </td>
                                        <td><input type="number" name="experience" placeholder="Kinh nghiệm"
                                                required></td>
                                        <td><input type="email" name="email" placeholder="Email" required></td>
                                        <td><input type="text" name="appointment_bids"
                                                placeholder="Gói thầu đang tư vấn" required></td>
                                        <td><input type="text" name="successful_bids"
                                                placeholder="Gói thầu tư vấn thành công" required></td>
                                        <td><input type="text" name="success_rate"
                                                placeholder="Tỉ lệ thành công (%)" required></td>
                                        <td>
                                            <button type="submit" class="btn btn-success">Thêm</button>
                                            <button type="button" class="btn btn-danger"
                                                id="cancelExpertBtn">Huỷ</button>
                                        </td>
                                    </tr>
                                </form>
                            </div><!-- .widget-body -->
    ...
    <script src="../assets/js/admin/experts.js"></script>
